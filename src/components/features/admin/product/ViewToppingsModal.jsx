...
const ViewToppingsModal = ({ toppings, onClose }) => (
  <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
    <div className="bg-white rounded shadow-lg p-0 max-w-md w-full relative overflow-hidden">
      {/* Bill shape header */}
      <div className="bg-green_starbuck rounded-t px-6 py-4 flex items-center justify-between">
