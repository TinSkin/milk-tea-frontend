            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-camel to-orange-600 rounded-lg flex items-center justify-center">
                            <Store className="w-5 h-5 text-white" />
                        </div>
                        <div>
                            <h2 className="text-xl font-semibold text-gray-900">Thêm cửa hàng mới</h2>
                            <p className="text-sm text-gray-600">Điền thông tin để tạo cửa hàng mới</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <Form className="p-6 space-y-6">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-camel text-white rounded-lg hover:bg-camel-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                >
